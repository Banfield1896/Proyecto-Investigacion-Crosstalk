//
// _coder_xtc_processor_func_api.cpp
//
...
emlrtContext emlrtContextGlobal{
    ...
    "xtc_processor_func",                                 // fFunctionName
...
void xtc_processor_func_api(const mxArray *const prhs[2], const mxArray **plhs)
{
  ...
  xtc_processor_func(in, &params, out);
...
void xtc_processor_func_atexit()
{
  ...
  xtc_processor_func_xil_terminate();
  xtc_processor_func_xil_shutdown();
...
// End of code generation (_coder_xtc_processor_func_api.cpp)
