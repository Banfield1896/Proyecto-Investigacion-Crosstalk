...
namespace coder {
void ifft(const creal_T x[8192], creal_T y[8192])
{
  static const double dv[4097]{1.0,
                               0.99999970586288223,
                               0.99999882345170188,
                               0.99999735276697821,
                               0.99999529380957619,
                               ...
                               -0.99999970586288223,
                               -1.0};
  static const double dv1[4097]{0.0,
                                0.00076699031874270449,
                                0.0015339801862847655,
                                0.002300969151425805,
                                0.0030679567629659761,
  ...
  for (iy = 0; iy < 8192; iy++) {
    y[iy].re *= 0.0001220703125;
    y[iy].im *= 0.0001220703125;
  }
}
